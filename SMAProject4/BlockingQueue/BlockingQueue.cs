 ...
 *   -------------------
 *   ver 4.2 : 20 Nov 2015
 *     - added test stub for blocking queue
 *   ver 4.1 : 23 Oct 2015
  ...
  public class BlockingQueue<T>
  {
    ...
    public void clear() 
    {
      lock(locker_) { blockingQ.Clear(); }
        ...
        //Test stub for blocking queue//
        static void Main(string []args)
        {
            BlockingQueue<string> b1 = new BlockingQueue<string>();
            b1.enQ("Test Message1");
            b1.enQ("test Message2");
            int count = b1.size();
            string msg = b1.deQ();
            string msg2 = b1.deQ();
            Console.WriteLine("First dequeued message: {0}\n", msg);
            Console.WriteLine("Second dequeued message: {0}\n", msg2);
        }
  }
}